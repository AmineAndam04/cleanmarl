...
if __name__ == "__main__":
    ...
    log_dir = f"{args.work_dir}/MAPPO-multienvs-{run_name}"
    ...
    while step < args.total_timesteps:
        ...
        # ---- Training loop -------
        ## Prepare the batch
        b_obs, b_actions, b_log_probs, b_avail_actions, b_returns, b_advantages, b_states = rb.get_batch()
