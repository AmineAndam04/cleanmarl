...
class LBFWrapper(CommonInterface):
    def __init__(self, map_name, reward_aggr="sum", time_limit=150, agent_ids=False, **kwargs):
        super().__init__()
        ...
        self.action_space = Tuple(tuple([self.env.action_space[agent] for agent in self.agents]))
