...
if __name__ == "__main__":
    ...
    log_dir = f"{args.work_dir}/COMA-lstm-{run_name}"
    ...
    while step < args.total_timesteps:
        ...
        while num_episode < args.batch_size:
            ...
            while not done and not truncated:
                ...
                episode["values"].append(value.cpu())
                obs = next_obs
            rb.add(episode)
            num_episode += 1
            ...
            if "smac" in args.env_type:
                ep_stats.append(infos.get("battle_won", False))
        ...
        for start in range(0, b_obs.size(1), args.tbptt):
            ...
            pi = pi.reshape(args.batch_size, env.n_agents, mb_obs.size(1), -1).transpose(1, 2).flatten(0, 1)
